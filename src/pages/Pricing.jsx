      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-8 mt-12">
          ...
          <motion.div 
            ...
            className="flex-1 max-w-md bg-white dark:bg-[#111] border border-slate-200 dark:border-slate-800 rounded-[2rem] p-8 shadow-sm flex flex-col"
          >
            <div className="mb-6">
          ...
          <motion.div 
            ...
            className="flex-1 max-w-md bg-white dark:bg-[#111] border-2 border-[#00b14f] rounded-[2rem] p-8 shadow-xl shadow-[#00b14f]/10 flex flex-col relative"
          >
            {/* MOST POPULAR BADGE */}
